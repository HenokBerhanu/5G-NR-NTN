...
if __name__ == "__main__":
    ...
    oai_spgwu = net.addDockerHost(
        ...
        ip="192.168.71.134 192.168.72.134",
    ...
    #subprocess.Popen(command, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True),
    
    
    # Create an additional interface for the Docker host
    #intf1 = Intf('eth1', node=oai_spgwu)
    #intf2 = Intf('eth2', node=oai_spgwu)

    # Assign IP addresses to the additional interfaces
    #intf1.setIP("192.168.72.134")
    #intf2.setIP("192.168.72.134")
    ...
    #oai_spgwu.cmd(*command)
    # Terminate existing instances of spgwu
    #oai_spgwu.cmd("pkill spgwu")
    
    # Access the Docker host using the Mininet command line interface
    #net["oai-spgwu"].cmd("bash")
    ...
    # oai_spgwu2.cmd("ip link add oai_spgwu2-eth1 type veth peer name rfsim5g-traffic-eth0")
    # oai_spgwu2.cmd("ip link set oai_spgwu2-eth1 up")
    # oai_spgwu2.cmd("brctl addif rfsim5g-traffic oai_spgwu2-eth1")
    
    # oai_ext_dn.cmd("ip link add oai_ext_dn-eth0 type veth peer name rfsim5g-traffic-eth1")
    # oai_ext_dn.cmd("ip link set oai_ext_dn-eth0 up")
    # oai_ext_dn.cmd("brctl addif rfsim5g-traffic oai_ext_dn-eth0")
    
    # oai_cu.cmd("ip link add oai_cu-eth0 type veth peer name rfsim5g-public-eth6")
    # oai_cu.cmd("ip link set oai_cu-eth0 up")
    # oai_cu.cmd("brctl addif rfsim5g-public oai_cu-eth0")
    
    # oai_du.cmd("ip link add oai_du-eth0 type veth peer name rfsim5g-public-eth7")
    # oai_du.cmd("ip link set oai_du-eth0 up")
    # oai_du.cmd("brctl addif rfsim5g-public oai_du-eth0")
    
    # oai_nr_ue.cmd("ip link add oai_nr_ue-eth0 type veth peer name rfsim5g-public-eth8")
    # oai_nr_ue.cmd("ip link set oai_nr_ue-eth0 up")
    # oai_nr_ue.cmd("brctl addif rfsim5g-public oai_nr_ue-eth0")
